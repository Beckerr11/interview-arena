...
const mvp = [
  "Desafios por stack e nivel de senioridade.",
  "Modo simulacao com timer e contexto de entrevista.",
  "Rubrica tecnica para autoavaliacao estruturada.",
  "Historico de tentativas e progresso."
];
const hero = "https://picsum.photos/seed/interview-arena-hero/1920/1080";
  ...
  return (
    <div className="page">
      <header className="hero full-bleed" style={{ "--hero": `url(${hero})` } as CSSProperties}>
        <nav className="nav"><p className="brand">Interview Arena</p><a className="btn btn-ghost" href="#mvp">MVP</a></nav>
        <div className="hero-content">
          <p className="eyebrow">edtech</p>
          <h1>Simulador de entrevista tecnica com treino orientado.</h1>
          <p className="lead">Candidatos praticam pouco sob pressao e sem avaliacao objetiva.</p>
      ...
      <main className="shell">
        ...
        <section className="section split" data-reveal>
          ...
          <article><p className="label">Produto</p><h2>Plano premium com trilhas e simulados avancados.</h2><p className="lead" style={{ color: "var(--muted)" }}>Base pronta para evoluir com autenticacao, banco e analytics.</p></article>
        </section>
      ...
      <footer className="footer"><p>Interview Arena</p><p>{new Date().getFullYear()} - Projeto com padrao senior.</p></footer>
    </div>
  );
}
