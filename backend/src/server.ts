...
const projectProfile = {
  ...
  "slug": "interview-arena",
  "tagline": "Treino pratico para entrevistas tecnicas com plano de evolucao.",
  "vertical": "edtech",
  "entity": {
    "singular": "simulado",
    "plural": "simulados"
  ...
  "copy": {
    "titleLabel": "Tema do simulado",
    "detailsLabel": "Foco tecnico da pratica",
    "createButton": "Criar simulado",
    "workspaceTitle": "Painel de simulados e evolucao",
    "workspaceDescription": "Organize treinos com disciplina para chegar pronto nas entrevistas."
  },
  "mvp": [
    "Gestao de simulados por nivel tecnico.",
    "Fila de estudos com prioridade por lacuna.",
    "Checklist de pratica para entrevistas reais.",
    "Monitoramento de progresso entre simulados."
  ],
  "workflow": [
    "Registrar simulado e objetivo de aprendizado.",
    "Executar treino com criterio de avaliacao claro.",
    "Concluir rodada e mapear proxima melhoria."
  ],
  "seedItems": [
    {
      "title": "Backend node com autenticao por token",
      "details": "Resolver caso de login social, refresh token e revogacao de sessao.",
      "priority": "high",
      "status": "open"
    },
    {
      "title": "Estruturas de dados para ranking",
      "details": "Treinar heap e mapa para responder consultas em tempo reduzido.",
      "priority": "medium",
      "status": "open"
    },
    {
      "title": "Apresentacao de projeto em 5 minutos",
      "details": "Pitch final feito com foco em problema, arquitetura e metricas.",
      "priority": "low",
      "status": "done"
    }
  ]
